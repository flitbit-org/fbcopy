...
namespace FlitBit.Copy
{
	...
	public static class Copier<TTarget>
	{
		...
		/// <returns>An instance of TTarget, populated with data from the sources.</returns>
		public static TTarget CopyEachSource<TS1, TS2, TS3, TS4, TS5, TS6>(IFactory factory, TS1 s1, TS2 s2, TS3 s3, TS4 s4, TS5 s5, TS6 s6)
		{
			Contract.Requires<ArgumentNullException>(factory != null);
			var c1 = factory.CreateInstance<ICopier<TS1, TTarget>>();
			var res = factory.CreateInstance<TTarget>();
		...
		/// <returns>An instance of TTarget, populated with data from the sources.</returns>
		public static TTarget CopyEachSource<TS1, TS2, TS3, TS4, TS5, TS6, TS7>(IFactory factory, TS1 s1, TS2 s2, TS3 s3, TS4 s4, TS5 s5, TS6 s6, TS7 s7)
		{
			Contract.Requires<ArgumentNullException>(factory != null);
			var c1 = factory.CreateInstance<ICopier<TS1, TTarget>>();
			var res = factory.CreateInstance<TTarget>();
		...
		/// <returns>An instance of TTarget, populated with data from the sources.</returns>
		public static TTarget CopyEachSource<TS1, TS2, TS3, TS4, TS5, TS6, TS7, TS8>(IFactory factory, TS1 s1, TS2 s2, TS3 s3, TS4 s4, TS5 s5, TS6 s6, TS7 s7, TS8 s8)
		{
			Contract.Requires<ArgumentNullException>(factory != null);
			var c1 = factory.CreateInstance<ICopier<TS1, TTarget>>();
			var res = factory.CreateInstance<TTarget>();
		...
		/// <returns>An instance of TTarget, populated with data from the sources.</returns>
		public static TTarget CopyEachSource<TS1, TS2, TS3, TS4, TS5, TS6, TS7, TS8, TS9>(IFactory factory, TS1 s1, TS2 s2, TS3 s3, TS4 s4, TS5 s5, TS6 s6, TS7 s7, TS8 s8, TS9 s9)
		{
			Contract.Requires<ArgumentNullException>(factory != null);
			var c1 = factory.CreateInstance<ICopier<TS1, TTarget>>();
			var res = factory.CreateInstance<TTarget>();
